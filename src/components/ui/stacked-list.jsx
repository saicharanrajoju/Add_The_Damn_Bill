        ...
        >
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 rounded-xl bg-background border border-border flex items-center justify-center text-muted-foreground/80 shadow-[0_1px_2px_rgba(0,0,0,0.02)] transition-transform group-hover/bar:scale-105">
                ...
                <div className="flex -space-x-3">
                  {ALL_MEMBERS.slice(0, 3).map((m) => (
                    <motion.img
                      ...
                      src={m.avatar}
                      className="w-10 h-10 rounded-full ring-1 ring-background shadow-sm"
                      alt="avatar"
                    />
                  ))}
                  <div className="w-10 h-10 rounded-full ring-1 ring-background bg-muted flex items-center justify-center shadow-sm">
                ...
                >
                  <div className="relative">
                    ...
                    <Input
                      ...
                      value={searchQuery}
                      onChange={(e) => setSearchQuery(e.target.value)}
                      className="h-10 bg-muted/30 border-none focus-visible:ring-1 focus-visible:ring-border rounded-xl text-sm pl-10"
                    />
                  </div>
                </motion.div>
              )}
